...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2021 a las 14:50:57
...
INSERT INTO `mensajes` (`id_emisor`, `id_receptor`, `texto`, `id`, `fecha_hora`) VALUES
('emy@404.es', 'nico@404.es', 'segundo mensaje a nico para pruebas', 2, '2021-01-27 13:45:31'),
('nico@404.es', 'nico@404.es', 'holaa', 3, '2021-01-27 14:48:38');
...
('3OHRysMKZUNJxWxBSx8bno4OnIjCu26R', 1611841719, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"currentUser\":\"nico@404.es\"}');
...
('nico@404.es', 46, 'Nico', '2021-01-14', 0, 1, 'foto-1610637072161.png', '12345678', 1, 'css3'),
...
--
ALTER TABLE `mensajes`
  ADD CONSTRAINT `mensajes_ibfk_1` FOREIGN KEY (`id_emisor`) REFERENCES `usuario` (`email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mensajes_ibfk_2` FOREIGN KEY (`id_receptor`) REFERENCES `usuario` (`email`) ON DELETE CASCADE ON UPDATE CASCADE;
